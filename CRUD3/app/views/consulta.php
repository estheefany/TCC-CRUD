...
<form method='GET' action='<?=route('consulta/index/')?>'>
...
<table class='table'>
    ...
    <tr>
        ...
        <td>
            ...
            <a href='<?=route("Consulta/agendar/{$item['id']}")?>'>Agendar</a>
            <?php endif; ?>
        </td>
        <?php endif; ?>
        ...
        <td>
            ...
            <a href='<?=route("consulta/desmarcar/{$item['id']}")?>'>Desmarcar consulta</a>
            <?php endif; ?>
        </td>
    </tr>
